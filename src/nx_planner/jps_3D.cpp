...
void JPS::JPS_3D::spin(Astate *currNode_pt)
{
...
void JPS::JPS_3D::jump(int x, int y, int z, int dx, int dy, int dz)
{
...
constexpr int JPS::JPS_NEIB::nsz_[4][3];
JPS::JPS_NEIB::JPS_NEIB()
{
...
void JPS::JPS_NEIB::Neib(int dx, int dy, int dz, int norm1, int dev,
...
void JPS::JPS_NEIB::FNeib( int dx, int dy, int dz, int norm1, int dev,
